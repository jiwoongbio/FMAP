...
* **FMAP_assembly.pl**
  ...
  * Input
    ...
    2. De novo assembled sequences in FASTA format
      * The FASTA files can be generated by metagenome assemblers such as [SPAdes](http://cab.spbu.ru/software/spades/) and [MetaVelvet](http://metavelvet.dna.bio.keio.ac.jp).
